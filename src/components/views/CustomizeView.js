    ...
    getKeybindActions() {
        return [
            ...
            },
            {
                ...
                description: 'Capture a screenshot to send to AI',
            },
            {
                key: 'nextStep',
                name: 'Send Message / Start',
                description: 'Send message in assistant view or start session in main view',
            },
            {
                ...
                <div class="settings-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group full-width">
                            <label class="form-label">Custom AI Instructions (Optional)</label>
                            <textarea
                                class="form-control"
                                placeholder="Leave empty for default friendly AI, or customize how you want the AI to behave. Examples: 'You are a coding tutor. Explain concepts clearly.' or 'You are a study buddy. Help me prepare for exams.'"
                                .value=${localStorage.getItem('customPrompt') || ''}
                                rows="6"
                                @input=${this.handleCustomPromptInput}
                            ></textarea>
                            <div class="form-description">
                                Optional: Customize the AI's personality and expertise. Leave blank for a friendly general-purpose assistant (default: "Hello, would you like any help?").
                            </div>
                        </div>
                    </div>
                </div>
